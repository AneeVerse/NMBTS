    ...
    <section className="py-16 lg:py-24 bg-navy">
      <div className="max-w-3xl mx-auto px-5 lg:px-8 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 bg-gold hover:bg-gold-dark text-navy font-semibold px-8 py-3.5 rounded-lg text-sm transition-all duration-200 hover:shadow-lg hover:shadow-gold/25"
        >
