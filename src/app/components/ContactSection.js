            ...
            <div className="bg-navy rounded-2xl p-8 h-full flex flex-col justify-between gap-8">
              ...
              <div className="space-y-5">
                ...
                >
                  ...
                  <div>
                    <div className="text-[10px] uppercase tracking-widest text-white/40 mb-1">Alt Phone</div>
                    <div className="text-sm text-white/80 group-hover:text-gold transition-colors">+91 93724 77160</div>
                  </div>
                </a>
